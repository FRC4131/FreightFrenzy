...
public class FieldCentricMecanumRed extends OpMode {
    ...
    public void loop() {
        ...
        //Compute offset based on right stick
        double offsetScaleFactor = 1.0;

//        if(Math.abs(gamepad2.right_stick_y) > 0.0)
//        {
//            offset = offset + gamepad2.right_stick_y*offsetScaleFactor;
//        }
...
//            arm2.setTargetPosition(335 + (int)offset);
//            arm2.setMode(DcMotor.RunMode.RUN_TO_POSITION);
//            arm2.setPower(1.0);
//            cappingHand.setPosition(0.52);
//        } else if (gamepad2.b){
